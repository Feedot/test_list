...
export default (state = initialState, { type, payload }) => {
    switch (type) {
        ...
        case "ADD_ITEM": add(state,"items",payload); break;
        case "DELETE_ITEM": del(state,'items',payload); break;
        case "ADD_COMMENT": add(state,"comments",payload); break;
        case "DELETE_COMMENT": del(state, 'comments' ,payload); break;
